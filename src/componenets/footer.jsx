                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 pb-20 border-b border-slate-100 dark:border-slate-800 mb-20">
                    <div className="lg:col-span-5 space-y-8">
                        <Link to="/" className="flex items-center gap-2 shrink-0">
                            ...
                            <span className={`text-lg sm:text-xl font-black tracking-tight darktext-white text-slate-900 dark:text-white`}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href="tel:" className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-slate-400 dark:text-slate-500 hover:bg-green-500 dark:hover:bg-green-500 hover:text-white transition-all border border-slate-100 dark:border-slate-800 group shadow-sm transition-all hover:-translate-y-1">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-reveal-container">
                        ...
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4">
                                {navLinks.map(link => (
                                    <li key={link.name}>
                                        <Link to={link.href} className="text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors uppercase tracking-tight">{link.name}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
